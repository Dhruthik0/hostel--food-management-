...
/* styles.css */
body {
  background: linear-gradient(135deg, rgba(255, 204, 255, 1), rgba(173, 216, 230, 1), rgba(255, 255, 224, 1)); /* Light pastel gradient */
  background-size: 400% 400%;
  animation: gradientAnimation 15s ease infinite; /* Animated gradient */
  font-family: 'Asap', sans-serif; /* $fontAsap */
  height: 100vh;
  margin: 0;
  display: flex;
...
.login > button:hover {
  background-color: #e53e62; /* darkened $redFire */
}
...
<body>
		...
		<form class="login" action = "valid.jsp" method ="post">
